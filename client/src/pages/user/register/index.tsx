...
import { Button, Col, Input, Popover, Progress, Row, Select, message, Tabs } from 'antd'
...
class Register extends Component<RegisterProps, RegisterState> {
	...
	checkConfirm = (rule: any, value: string, callback: (message?: string) => void): void => {
		const { form } = this.props
	...
	checkPassword = (rule: any, value: string, callback: (message?: string) => void): void => {
	...
	renderPasswordProgress = (): JSX.Element | null => {
		const { form } = this.props
		const value = form.getFieldValue('password')
...
export default connect(
	({ userAndregister, loading }: { userAndregister: StateType; loading: { effects: { [key: string]: boolean } } }) => ({
		userAndregister,
