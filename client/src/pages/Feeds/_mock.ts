...
const desc = [
	'Its an inner thing, they cant reach it, they cant touch it',
	'Hope is a good thing, maybe the best, and good things will not die out',
...
function getFakeList(req: Request, res: Response): object {
