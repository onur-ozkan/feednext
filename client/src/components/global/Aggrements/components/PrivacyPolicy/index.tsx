...
export const PrivacyPolicy = () => (
	<div style={{ height: 650, overflow: 'scroll' }}>
		...
		<p>
			...
			at Feednext unless otherwise defined in this Privacy Policy.
		</p>
		<p>
		...
		<p>
			...
			identifiable information, including but not limited to Name and surname, email, social media profiles. The
		...
		<p>
			If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at <a href="mailto:contact@feednext.io">contact@feednext.io</a>
		</p>
	</div>
)
